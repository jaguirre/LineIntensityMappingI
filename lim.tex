...
\begin{figure}[h]
\centering
\includegraphics[width = 0.5\textwidth]{pcii_STARFIRE_z63_z88_z116_z148_halofit_bethermin_spinoglio_ap2p5m_5p3sqdeg_uhp_ktnonzero_space}
\caption{Same as previous figure, except for the space telescope and 5 square degree survey area.}
%\label{fig:pcii_zall}
\end{figure}

\begin{figure}[h]
 \centering
 \includegraphics[width=0.5\textwidth]{SNRtot_starfire_cii_z1p5_5p3sqdeg_tsurvey_alpham_im_VpixR450_0p1Vpix_10Vpix_Lstar1d12_Lmin1d8_Lmax1d13_space}
\caption{Same as previous figure, except for the space telescope and 5 square degree field.}
%\label{fig:snr_vs_time_z1p5}
\end{figure}
...
\begin{figure*}[h]
 ...
 \subfloat{
 \label{}
 \includegraphics[width=0.5\textwidth]{Ngal_cii_STARFIRE_5p3sqdeg_z1p5_tsurvey_0p1vpix_vpix_10vpix_alpham1p0_alpham1p5_alpham2p0_space}}
 \subfloat{
 \label{}
 \includegraphics[width=0.5\textwidth]{frac_cii_STARFIRE_5p3sqdeg_z1p5_tsurvey_0p1vpix_vpix_10vpix_alpham1p0_alpham1p5_alpham2p0_space}}
 \centering
\caption{Same as previous figure, except for the space telescope and 5 square degree field.}
%\label{fig:ngal_frac}
\end{figure*}
