...
In Figure ~\ref{fig:ngal_vs_time_z1p5}, the SNR for the galaxy surveys is broken down in terms of the number of 5$\sigma$ detections (top panel) and the observed luminosity density, $\rho_{[CII]}$, relative to the total [CII] luminosity density, $\rho_{[CII]}$ (bottom panel). In the small pixel limit, the galaxy survey reaches SNR $\sim10$ at $t_{obs}^{survey} = 700$ hours, at which time it detects $\sim1,000$ galaxies. In sum, these galaxies account for roughly half of $\rho_{[CII]}$ at $ z = 1.5$. Recall that $\frac{\rho_{[CII], obs}}{\rho_{[CII]}} = 1$  for intensity mapping at all observing times. 
...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.4\textwidth]{SNRtot_starfire_cii_1sqdeg_z1p5_tsurvey_alpham_im_VpixR450_0p1Vpix_10Vpix_Lstar1d12_Lmin1d8_Lmax1d13}
...
\begin{figure*}[h]
 ...
 \subfloat{
 \label{}
 \includegraphics[width=0.4\textwidth]{Ngal_cii_STARFIRE_1sqdeg_z1p5_tsurvey_0p1vpix_vpix_10vpix_alpham1p0_alpham1p5_alpham2p0}}
 \subfloat{
 \label{fig:bethermin_fir_frac}
 \includegraphics[width=0.4\textwidth]{frac_cii_STARFIRE_1sqdeg_z1p5_tsurvey_0p1vpix_vpix_10vpix_alpham1p0_alpham1p5_alpham2p0}}
 \centering
