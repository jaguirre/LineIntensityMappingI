...
\begin{figure}[!h]
\centering
\includegraphics[width=0.4\textwidth]{snr_nmode_vs_k_starfire_ap2p5m_0p1vpix_10vpix_1sqdeg_5p3sqdeg_10sqdeg_ktnonzero}
...
Recall that the units of $\frac{\sigma_{N}}{\sqrt{t_{pix}}}$ and $S_{i}$ are Jy sr$^{-1}$, which does not depend on aperture. For this analysis, we assume the galaxy surveys have reliable spectroscopic redshifts and thus neglect the problem of confusion noise when estimating $L_{i,min}$. %One converts between $\sigma_N$ and $S_{\gamma}$ by dividing (or multiplying) by the frequency resolution d$\nu$ and beam solid angle d$\Omega$.
 ...
 \begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{lirmin_lsun_moretsurvey_z1p5_0p1vpix_vpix_10vpix}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.4\textwidth]{SNRtot_starfire_cii_z1p5_5p3sqdeg_tsurvey_alpham_im_VpixR450_0p1Vpix_10Vpix_Lstar1d12_Lmin1d8_Lmax1d13}
\caption{Total Signal-to-Noise ratio ($\textrm{SNR}_{tot}$) on the clustering power spectrum of [CII] at $z=1.5$ as a function of the survey observing time (in hours). $\textrm{SNR}_{tot}$ as computed from intensity mapping---which depends only on the integral of the luminosity function, and not the shape---and from the Schechter function models are plotted. Magenta curves represent the intensity mapping experiment. Cyan, black, and green dashed lines correspond to galaxy survey experiments with pixel volumes 0.1, 1.0, 10.0 times the fiducial value. The horizontal dotted \emph{red line} is the maximum SNR, set by the number of modes in the survey volume. Note that the mean [CII] intensity is increasing for decreasing faint-end slopes, which is a consequence of fixing the total IR light for a given Schechter model to the B11 value, and then applying the $L_{[CII]}-L_{IR}$ relation to predict [CII] luminosity.}
 \label{fig:snr_vs_time_z1p5}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{Ngal_frac_cii_STARFIRE_5p3sqdeg_z1p5_tsurvey_0p1vpix_vpix_10vpix_alpham1p0_alpham1p5_alpham2p0}
\caption{(\emph{Top panel}) The number of $5\sigma$-detected galaxies at $z=1.5$ in a galaxy redshift survey as a function of the survey observing time for telescopes with voxel sizes 0.1 (cyan), 1.0 (black), and 10.0 (green) $V_{pix}$. (\emph{Bottom panel}) The fraction of the luminosity density in [CII] emitted by the population of observed galaxies relative to the total luminosity density in [CII] at $z=1.5$ according to the toy Schechter model of a given slope $\alpha$.}
\label{fig:ngal_frac_vs_time_z1p5}
\end{figure}

 \begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{lirmin_lsun_moretsurvey_z6_0p01vpix_vpix}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.4\textwidth]{SNRtot_starfire_cii_z6_5p3sqdeg_tsurvey_alpham_im_VpixR450_0p01Vpix_10Vpix_Lstar1d12_Lmin1d8_Lmax1d13}
\caption{Total Signal-to-Noise ratio ($\textrm{SNR}_{tot}$) on the clustering power spectrum of [CII] at $z=1.5$ as a function of the survey observing time (in hours). $\textrm{SNR}_{tot}$ as computed from intensity mapping---which depends only on the integral of the luminosity function, and not the shape---and from the Schechter function models are plotted. Magenta solid curves represent the intensity mapping experiment and the cyan and black dashed lines correspond to a galaxy survey experiment with pixel volumes 0.01 times the fiducial value, or telescope aperture $D_{ap} = 25.0$ m, and the fiducial 2.5 m telescope. The horizontal dotted \emph{red line} is the maximum SNR, set by the number of modes in the survey volume.}
 \label{fig:snr_vs_time_z6}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{Ngal_frac_cii_STARFIRE_5p3sqdeg_z6_tsurvey_0p01vpix_vpix_10vpix_alpham1p0_alpham1p5_alpham2p0}
\caption{(\emph{Top panel}) The number of $5\sigma$-detected galaxies at $z=6$ as a function of the survey observing time. The solid line corresponds to observations made with the galaxy survey experiment with aperture 2.5 m, and the cyan line corresponds to the galaxy survey experiment with 25.0 m aperture. (\emph{Bottom panel}) The fraction of the luminosity density in [CII] emitted by the population of observed galaxies relative to the total luminosity density in [CII] at $z=6$ according to the toy Schechter model of a given slope $\alpha$.}
