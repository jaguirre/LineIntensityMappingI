...
To convert the infrared luminosity to a line luminosity, we apply the relation for $L_{i}$ as a function of $L_{IR}$ provided by \citet{spinoglio12}. The fit in their paper was based on the collection of ISO-LWS observations of local galaxies in \citet{brauher08}, and is reproduced below for [CII]: 
\begin{equation}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{contour_depth_alpha_cii}
