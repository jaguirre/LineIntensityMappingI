...
\begin{gather}
\bar{S}_{\mathrm{i}}(z) = \int \mathrm{d}L_{IR}  \Phi(L_{IR}, z) \frac{f_{i}}{4 \pi D_{L}^2} \frac{1}{\mathrm{ln}10} y D_A^2 \\
...
We present in this section predictions for the power spectrum of bright far-IR emission lines, namely,  [CII], [OI]63, [OIII]88, and [SiII]35, which are observable in the redshift range $0.5<z<3$ with an atmospheric balloon or space instrument.

Motivate the choice of these lines. dominant coolants of gas in galaxies... short wavelengths probe higher redshift (with SAFARI)

 %[CII] and [OI]63 are dominant coolants of the neutral hydrogen gas in galaxies, and are thus typically the brightest emission lines observed in the FIR, contributing between 0.01 to 1\% of galactic IR luminosity in some cases. [SiII], though relatively weaker in intensity, is useful in observing the high redshift regime due to its shorter wavelength. 

For observing [CII]158, we envision a balloon experiment with uninterrupted spectral coverage in the wavelength range 240 to 420 $\mu$m, or $z = 0.5-1.5$. We take the fiducial experimental parameters for the telescope mirror, survey area, and total observing time to be 3.0 m, 1 deg$^2$, and 200 hours, resp, though we explore variations in these parameters (cf. Table 1). For the redshifts $z = 0.5-3$, the lines [OI]63, [OIII]88, and [SiII]35 fall within the wavelength coverage of the SAFARI instrument (30-210$\mu$m) aboard future Japanese space mission SPICA. SAFARI is planned to be a part of the Focal Plane Instrument Suite. 
...
%\includegraphics[width=0.4\textwidth]{pcii_z88_halofit_bethermin_spinoglio_witherror_constlogk_ICarISkmodes_ap3m_1sqdeg_uhp_obs} \\
...
\centering
\begin{tabular}{cc}
%\includegraphics[width=0.4\textwidth]{snr_vs_kbin_apertures_asurveys_all_z88.pdf} &
...
\subsection{[OI]63, [OIII]88, [SiII]35}
